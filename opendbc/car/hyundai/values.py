...
class CAR(Platforms):
  ...
  KIA_EV4 = HyundaiCanFDPlatformConfig(
    ...
    flags=HyundaiFlags.EV | HyundaiFlags.CANFD | HyundaiFlags.CANFD_LKA_STEERING | HyundaiFlags.CANFD_LKA_STEERING_ALT | HyundaiFlags.CANFD_ALT_BUTTONS | HyundaiFlags.CANFD_CAMERA_SCC,
  )
