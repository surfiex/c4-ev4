...
class CarController(CarControllerBase):
  ...
  def create_canfd_msgs(self, apply_steer_req, apply_torque, set_speed_in_units, accel, stopping, hud_control, CS, CC):
    ...
    # steering control
    can_sends.extend(hyundaicanfd.create_steering_messages(self.packer, self.CP, self.CAN, CC.enabled, apply_steer_req, apply_torque, CS.lkas_alt_msg))
    ...
    if self.CP.openpilotLongitudinalControl:
      ...
      if self.frame % 2 == 0:
        can_sends.append(hyundaicanfd.create_acc_control(self.packer, self.CAN, self.CP, CC.enabled, self.accel_last, accel, stopping, CC.cruiseControl.override,
